...
// HCons(head=1000, tail=HCons(head=900, tail=arrow.generic.HNil@1788b152))
```

```kotlin
Account(1000, 900).toHListLabeled()
// HCons(head=Tuple2(a=balance, b=1000), tail=HCons(head=Tuple2(a=available, b=900), tail=arrow.generic.HNil@1788b152))
```
...
// DeferredK(deferred=LazyDeferredCoroutine{New}@14c53adf)
```
