...
Option.monadError()
// arrow.instances.option.monadError.OptionMonadErrorInstanceKt$monadError$1@389d57fa
```
...
Try.monadError()
// arrow.instances.try.monadError.TryMonadErrorInstanceKt$monadError$1@3a6ab071
```
...
// arrow.instances.either.monadError.EitherMonadErrorInstanceKt$monadError$1@e7724da
```
