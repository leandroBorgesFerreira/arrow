...
```kotlin
String.eq()
// arrow.instances.StringKt$eq$1@3e8f2bf3
```

```kotlin
Option.functor()
// arrow.instances.option.functor.OptionFunctorInstanceKt$functor$1@112a8185
```
...
// arrow.instances.mapk.semigroup.MapKSemigroupInstanceKt$semigroup$1@5e797855
```

```kotlin
Either.monadError<Throwable>()
// arrow.instances.either.monadError.EitherMonadErrorInstanceKt$monadError$1@4c05a831
```

```kotlin
ListK.traverse()
// arrow.instances.listk.traverse.ListKTraverseInstanceKt$traverse$2@31b127cf
```
...
ListK.functor()
// arrow.instances.listk.functor.ListKFunctorInstanceKt$functor$1@3b465e88
```
